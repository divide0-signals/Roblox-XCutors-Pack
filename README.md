...
- Windows desktop application for easy access
- User-friendly interface for script management
- Quick startup and script loading
- Secure and stable performance
- Regular updates for compatibility
- Lua script support for customization
- Organized script library and configuration
...
XCutors is a collection of popular Roblox executors and a universal loader for running Lua scripts on Windows desktop.

### Is XCutors safe to use?

XCutors is designed for safe script execution, but always use tools responsibly and at your own risk.

### Which executors are included?

The package includes Volt, Synapse Z, Potassium, Wave, and a universal loader called xcutorsLoader.

### How do I install XCutors?

Follow the installation steps provided in the README or on the website, which involve downloading and running the installer.

### Can I use XCutors on Mac or Linux?

Currently, XCutors is only available for Windows desktop operating systems.

### Do I need to pay for XCutors?

XCutors itself is free, but individual executors might have their own licensing terms.

### How do I update XCutors?

Check the GitHub repository for new releases or enable automatic updates within the application settings.

### What scripts can I run with XCutors?

XCutors supports Lua scripts for Roblox games, allowing for customization and enhanced gameplay features.
